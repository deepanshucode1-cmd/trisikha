          ...
          <>
            <div className="space-y-4">
              {items.map((item) => (
                <div
                  key={item.id}
                  className="flex justify-between items-center bg-[#464433]/60 hover:bg-[#54513f]/70 transition rounded-2xl p-5 shadow-md backdrop-blur-sm"
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1 text-[#d8d3a6]">
